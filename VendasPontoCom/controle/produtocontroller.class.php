...
class ProdutoController extends ControllerAbstract {
    ...
    public function __construct () {
        ...
        $this->produtoView->geraInterface (true);
    }
    ...
    private function consultaProduto () {
        ...
        if ($buscou) {
            ...
            //se retornar com erro repassa as mensagens para a interface.
            $this->produtoView->adicionaMensagem("Não foi possível encontrar o produto! Tente novamente ou informe o problema ao responsável pelo sistema.");
        }
    }
